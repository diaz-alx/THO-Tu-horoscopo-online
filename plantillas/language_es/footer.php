<?php function footer_index(){ ?>
				<div class="footer">
				<a href="javascript:enviarIdioma('sp');"><img width="30" src="<?php echo RUTA; ?>img/languageES.png" alt="Idioma Español"></a>
